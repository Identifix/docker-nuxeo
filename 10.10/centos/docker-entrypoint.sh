...
# the following code block is an addition between 9.10 and 10.10, I am not sure we want to utilize this code block -LS
...
#this 'console' code block was added to mirror existing logic in the 9.10 version
  if [ "$2" = "console" ]; then
