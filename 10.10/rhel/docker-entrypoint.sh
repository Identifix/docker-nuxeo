...
## Allow supporting arbitrary user id        THIS CODE BLOCK WAS ADDED BETWEEN 9.10 AND 10.10, do we wish to keep it?  -LS Mar, 1, 2019
...
#  below code block carried over from our 9.10 versioning
  if [ "$2" = "console" ]; then
